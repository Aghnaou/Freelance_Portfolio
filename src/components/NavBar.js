        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto modern-nav">
              ...
              <Nav.Link href="#services" className={activeLink === 'services' ? 'active navbar-link modern-link' : 'navbar-link modern-link'} onClick={() => onUpdateActiveLink('services')}>
            ...
            <span className="navbar-text modern-social">
              <div className="social-icon modern-social-icons">
                ...
                <a href="https://github.com/aghnaoumohamed" target="_blank" rel="noopener noreferrer" className="social-link">
